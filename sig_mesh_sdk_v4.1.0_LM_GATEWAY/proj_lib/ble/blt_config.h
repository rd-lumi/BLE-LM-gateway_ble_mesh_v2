...
#define		MY_RF_POWER_INDEX		RF_POWER_P7p02dBm
			#else
#define		MY_RF_POWER_INDEX		RF_POWER_P10p29dBm
    		#endif
		#elif(MCU_CORE_TYPE == MCU_CORE_8278)
...
enum{
    ...
    HCI_GATEWAY_CMD_REBOOT	              = 0x13,
    HCI_GATEWAY_CMD_PERIPHERAL            = 0x14,

    /* Send cmd by user */
    HCI_GATE_WAY_CMD_GET_VC_NODE_INFOR    = 0x7a,
    HCI_GATEWAY_CMD_SET_LAST_UNICAST_ADR  = 0x7b,
    HCI_GATEWAY_CMD_DELETE_APPKEY         = 0x7c,
    HCI_GATEWAY_CMD_UPDATE_APPKEY         = 0x7d,
    HCI_GATEWAY_CMD_ADD_APPKEY            = 0x7e,
    HCI_GATEWAY_CMD_GET_APPKEY            = 0x7f,
...
//	HCI_GATEWAY_CMD_OTS_TX					= 0x21,
	...
	/* rsp cmd by user */
	HCI_CMD_GATEWAY_VC_PERIPHERAL_RSP    = 0xf9,
	HCI_CMD_GATEWAY_VC_NODE_INFOR_RSP    = 0xfa,
	HCI_CMD_GATEWAY_SET_LAST_UNICAST_RSP = 0xfb,
    HCI_GATEWAY_CMD_DELETE_APPKEY_STATUS = 0xfc,
    HCI_GATEWAY_CMD_UPDATE_APPKEY_STATUS = 0xfd,
    HCI_GATEWAY_CMD_ADD_APPKEY_STATUS    = 0xfe,
	HCI_GATEWAY_CMD_SEND_APPKEY          = 0xff,
};
//---------hci_cmd_from_usb
enum{
