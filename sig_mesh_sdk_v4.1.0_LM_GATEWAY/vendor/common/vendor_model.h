...
// Energy Report
#define VD_NEMA_ENERGY_REPORT           0xDC
...
#define VD_EXECUTION_SCENE_SET            0xF6
#define VD_EXECUTION_SCENE_RESPONSE       0xF7

// Vendor Config Node Set ACK
#define VD_CONFIG_NODE_SET                0xF8
